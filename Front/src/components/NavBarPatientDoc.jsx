    ...
    <div className="w-full py-4 px-6  text-white flex-col md:flex-row    items-center justify-between">
      ...
      <div className=" flex items-center justify-between    gap-4">
        <div className="left bg-white p-2  rounded-full flex items-center shadow-md">
          ...
          <input
            className="border-none text-black outline-none rounded ml-2 w-30 sm:w-64 md:w-44 lg:w-96"
            type="text"
            placeholder="Search"
          />
        </div>
        <div className="right flex items-center   w-full justify-end">
          <div className=" p-2 rounded-full flex items-center ">
            <Person2Icon className="text-white" />
            <span className="ml-2 hidden md:hidden lg:block">Sign in</span>
          </div>
