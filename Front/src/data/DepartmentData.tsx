...
const departments: Department[] = [
  ...
  },
  {
    ...
    title: "Surgery",
    description:
      "The Surgery department is committed to delivering top-tier surgical care across a variety of specialties. Our skilled surgeons employ advanced techniques, both traditional and minimally invasive, to perform procedures that range from routine surgeries to complex operations. Patient safety and recovery are our top priorities, with a focus on achieving the best possible outcomes.",
  },
  {
    icon: (
      <svg
    ...
    title: "First Aid",
    description:
      "Our First Aid department is designed to provide immediate and effective care for minor injuries and urgent medical conditions. Staffed with trained professionals, we ensure quick response times and essential treatments to stabilize patients and prevent further complications. Our goal is to offer rapid care in critical moments, with the resources needed to handle any emergency.",
  },
  {
    icon: (
      <svg
